...
<body>
 <div id="wrapper">
        ...
        <script src="${pageContext.request.contextPath}/js/flot/excanvas.min.js"></script>
        ...
        <script src="${pageContext.request.contextPath}/js/flot/jquery.flot.time.js"></script>
        <script src="${pageContext.request.contextPath}/js/flot/jquery.flot.tooltip.min.js"></script>
